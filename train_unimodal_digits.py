import torch
from data.dataset import load_digits_dataset
from torch.utils.data import DataLoader, TensorDataset
from models.unimodal import UnimodalModelDigits
...
for seed in seeds:
    ...
    torch.save(model.state_dict(), f"checkpoints/digits_unimodal_seed{seed}.pth")
    print(f"Model saved to checkpoints/digits_unimodal_seed{seed}.pth")